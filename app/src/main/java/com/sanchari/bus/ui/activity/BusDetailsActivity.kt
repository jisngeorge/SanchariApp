...
import com.sanchari.bus.ui.adapter.BusStopAdapter
import com.sanchari.bus.ui.helper.BusSubmissionHandler
import com.sanchari.bus.ui.adapter.CommentAdapter
import com.sanchari.bus.data.manager.CommunityDataManager
...
class BusDetailsActivity : AppCompatActivity() {
    ...
    private fun setupRunningStatusUI() {
        ...
        if (service.isRunning) {
            binding.toggleGroupStatus.check(com.sanchari.bus.R.id.buttonStatusYes)
        } else {
            binding.toggleGroupStatus.check(com.sanchari.bus.R.id.buttonStatusNo)
        }
        ...
        if (service.lastReportedTime > 0) {
            try {
                ...
                binding.textViewLastReported.text = getString(com.sanchari.bus.R.string.label_last_reported,sdf.format(date))
        ...
        binding.toggleGroupStatus.addOnButtonCheckedListener { group, checkedId, isChecked ->
            ...
            val isNowRunning = checkedId == com.sanchari.bus.R.id.buttonStatusYes
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            withContext(Dispatchers.Main) {
                ...
                if (stops.isEmpty()) {
                    ...
                    binding.textViewError.text = getText(com.sanchari.bus.R.string.msg_no_stops_found)
                } else {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            withContext(Dispatchers.Main) {
                if (rating != null && rating.ratingCount > 0) {
                    ...
                    binding.textViewRatingCount.text = getString(com.sanchari.bus.R.string.label_based_on_ratings, rating.ratingCount)
